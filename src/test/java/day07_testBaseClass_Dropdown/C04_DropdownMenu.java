...
public class C04_DropdownMenu extends TestBase {
    ...
    public void dropdownTesti(){
        ...
        //10. currency olaraka “US Dollars” in secilmedigini test edin
        ...
        //13. “Foreign currency cash was successfully purchased.” yazisinin ciktigini kontrol edin.
            WebElement uyarıYazisiElementi = driver.findElement(By.id("alert_content"));

            String expectedUyarıYazisi = "Foreign currency cash was successfully purchased.";
            String actualUyariYazisi = uyarıYazisiElementi.getText();

            Assert.assertEquals(expectedUyarıYazisi,actualUyariYazisi);
